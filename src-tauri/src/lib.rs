...
fn handle_deeplink_url(
    ...
    if !url_str.starts_with("ccviewer://") {
        return false;
    }
...
pub fn run() {
    ...
    let builder = builder
        ...
        .setup(|app| {
            ...
            //
            // 捕获首次运行快照：所有全新装用户都会看到欢迎弹窗介绍 CC Viewer 的工作方式。
            ...
            #[cfg(any(target_os = "linux", all(debug_assertions, windows)))]
            {
                #[cfg(target_os = "linux")]
                {
                    ...
                    // tauri-plugin-deep-link writes to: ~/.local/share/com.ccviewer.desktop/applications/cc-switch-handler.desktop
                ...
                move |event| {
                    ...
                    for (i, url) in urls.iter().enumerate() {
                        ...
                        if handle_deeplink_url(&app_handle, url_str, true, "on_open_url") {
                            break; // Process only first ccviewer:// URL
                        }
                    }
                }
            });
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // ccViewer commands
            ccviewer::commands::get_claude_dir,
            ccviewer::commands::get_claude_dir_tree,
            ccviewer::commands::read_file_content,
            ccviewer::commands::read_json_file,
            ccviewer::commands::execute_claude_command,
            ccviewer::commands::get_claude_version,
            ccviewer::commands::get_claude_skills,
            ccviewer::commands::get_claude_plugins,
    ...
    app.run(|app_handle, event| {
        ...
        #[cfg(target_os = "macos")]
        {
            match event {
                ...
                // 处理通过自定义 URL 协议触发的打开事件（例如 ccviewer://...）
...
fn show_migration_error_dialog(app: &tauri::AppHandle, error: &str) -> bool {
    ...
    let message = if is_chinese_locale() {
        ...
        format!(
            ...
            Consider rolling back to an older CC Viewer version.\n\n\
...
fn show_database_init_error_dialog(
    ...
    let message = if is_chinese_locale() {
        ...
        format!(
            ...
            2) If you see “database version is newer”, please upgrade CC Viewer\n\

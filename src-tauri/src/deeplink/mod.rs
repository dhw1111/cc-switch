//! Deep link import functionality for CC Viewer
//!
//! This module implements the ccviewer:// protocol for importing configurations
...
///
/// Represents a parsed ccviewer:// URL ready for processing.

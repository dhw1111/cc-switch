...
//!
//! Parses ccviewer:// URLs into DeepLinkImportRequest structures.
...
/// Parse a ccviewer:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// ccviewer://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "ccviewer" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'ccviewer', got '{scheme}'"
        )));
    }
